...
import { useGetSingleResultQuery } from '../../../../services/resultApi'
...
function Final_Result() {
    ...
    const { data: response, isLoading } = useGetSingleResultQuery({ attemptID })
    useEffect(() => {
        if (response) {
                                                        ...
                                                        item?.options ? (
                                                            ...
                                                            Object.values(item?.options).map((option, index) => {
                                                                ...
                                                                return <>
                                                                    ...
                                                                    <div className="form-check d-flex" key={item._id} style={{ backgroundColor: right ? '#f0fdf8' : null }}>
                                                                        <div style={{ width: '5%' }}>
                                                                            {
